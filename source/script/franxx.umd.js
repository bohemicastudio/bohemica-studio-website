(function (global, factory) {
  ...
  (global = global || self, factory(global.franxx = {}));
  ...
  function locationToPath(location) {
    if (typeof location === 'object') {
      return ("" + (location.pathname || '') + (typeof location.query === 'string' ? location.query : location.query ? querystringify_1.stringify(location.query, true) : '') + (location.hash || ''));
    }
  ...
  function pathToLocation(path) {
    if (typeof path === 'object') {
      ...
      return {
        ...
        get query() {
          return typeof query === 'string' ? querystringify_1.parse(query) : query;
        },

        get search() {
          return typeof query === 'string' ? query : querystringify_1.stringify(query);
        },
    ...
    return {
      ...
      get query() {
        return querystringify_1.parse(search);
      },
